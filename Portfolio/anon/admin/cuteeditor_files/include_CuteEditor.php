...
//********************************************************
  ...
  { 
    ...
    if ($this->subsequent==false)
    {
      $s="<script language=\"JavaScript\" SRC=\"".$this->FilesPath."/Scripts/Constant.js\"></script></script>";
    } 
    return $s;    
  } 
...
//--------------------------------------	
  ...
  function LoadHTML($FilePath)
  {
	...
	function GetToolbarFromItemList($templatelist,$d_list)
	{
		...
		$xml = simplexml_load_file($this->fixURL("/Configuration/AutoConfigure/Simple.config"));
		if ($xml == false) {
